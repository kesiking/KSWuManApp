...
#define UI_ORANGE_COLOR [UIColor colorWithRed:0.981 green:0.545 blue:0.124 alpha:1.000]
...
- (UIView *)hudView {
    if(!hudView) {
        ...
        hudView.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:1];
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
		...
		stringLabel.textColor = UI_ORANGE_COLOR;
